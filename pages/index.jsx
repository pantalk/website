          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              {platforms.map((platform, i) => (
                <div
                  key={platform.name}
                  className="platform-float inline-flex items-center gap-2.5 pl-3 pr-4 py-2 rounded-full border border-accent/25 backdrop-blur-sm text-sm font-medium text-content bg-accent/5"
                  style={{
            ...
            <p className="text-lg md:text-xl text-content-secondary max-w-xl mb-8">
              ...
              agents send, receive, and stream messages through a single
              local interface.
            </p>
