...
const features = [
  ...
  },
  {
    ...
    description:
      'Give your AI agent a voice on Slack, Discord, Mattermost, Telegram, WhatsApp, and Matrix from one unified interface. No per-platform code.',
  },
  {
    icon: Cable,
...
const skills = [
  {
    ...
    title: 'Send Message',
    description:
      'Send messages to any channel or thread across Slack, Discord, Mattermost, Telegram, WhatsApp, and Matrix.',
  },
  {
    icon: BellRing,
...
const useCases = [
  ...
  },
  {
    ...
    description:
      'Deploy one AI agent across Slack, Discord, Mattermost, Telegram, WhatsApp, and Matrix without writing provider-specific code.',
    icon: Server,
  },
]
                ...
                {[
                  {
                    ...
                    description:
                      'Define which Slack, Discord, Mattermost, Telegram, WhatsApp, or Matrix channels your agent should monitor and respond in.',
                  },
                  {
                    step: '02',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-4">
                {[
                  'Persistent connections to Slack, Discord, Mattermost, Telegram, WhatsApp, and Matrix',
  ...
  return (
    <>
      <Meta
        ...
        description="Pantalk is an open source daemon that gives AI agents a single local interface to communicate across Slack, Discord, Mattermost, Telegram, WhatsApp, and Matrix."
        keywords={[
          'pantalk',
          'ai agent',
          'ai agent chat',
