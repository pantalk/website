        ...
        <div className="container">
          <div className="max-w-2xl mx-auto space-y-8 text-lg leading-relaxed">
            ...
            <p className="text-content-secondary">
              ...
              WhatsApp, IRC, Matrix - each one speaks a different language with
  ...
  return (
    <>
      <Meta
        ...
        description="Pantalk is an open source daemon that gives AI agents a single local interface to communicate across Slack, Discord, Mattermost, Telegram, WhatsApp, IRC, and Matrix. Here's why it exists."
        keywords={[
          'pantalk',
          'about',
          'ai agent',
