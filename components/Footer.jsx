          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="max-w-lg">
              ...
              <p className="text-content-secondary">
                Open source. Actively developed. Come hang out.
              </p>
            </div>
            ...
            <div className="flex items-center gap-4">
              <Link
                href="#installation"
                className="px-6 text-sm py-3 bg-accent hover:bg-accent-secondary text-black font-medium flex items-center justify-center gap-2 transition-all whitespace-nowrap"
              >
                Install Pantalk
              ...
              <Link
                ...
                className="px-6 text-sm py-3 bg-background-secondary text-content-secondary hover:text-content border border-stroke flex items-center justify-center gap-2 hover:bg-background-tertiary transition-all whitespace-nowrap"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
            ...
            {[
              ...
              },
              {
                title: "Resources",
                links: [
                  { name: "GitHub", href: "https://github.com/pantalk" },
                  {
                    name: "Issues",
